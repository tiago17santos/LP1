        ...
        do{
            switch (menu()){
                case 1:
                    ...
                    if(op.equals("s")){
                        System.out.println("Qual novo email: ");
                        String novoEmailAluno = sc.nextLine();
                        aluno.alterarEmail(novoEmailAluno);
                    }

                    System.out.println("Você deseja alterar a idade? (s/n) ");
                    op = sc.next();
                ...
                case 4:
                    ...
                    String corBola = sc.next();

                    System.out.println("Qual a marca da sua bola?  ");
                    String tipoBola = sc.next();

                    System.out.println("Qual a quantidade de ar da sua bola?  ");
                    ...
                    System.out.println("Você deseja inflar ou esvaziar a bola? (i/e) ");
                    op = sc.next();
                ...
                case 5:
                    ...
                    System.out.print("Deseja adicionar ou remover um aluno? (a/r): ");
                    op = sc.next();

                    if(op.equals("a")){
                        System.out.println("Digite o nome do aluno que será adicionado: ");
                        String nomeAlunoNovo = sc.next();
                        escola.adicionarAluno(nomeAlunoNovo);
                    } else if (op.equals("r")) {
                        System.out.println("Digite o nome do aluno que será removido: ");
                        String nomeAlunoRem = sc.next();
                        escola.removerAluno(nomeAlunoRem);
                    }else{
                        System.out.println("Essa opção não válida");
                    }
                ...
                case 7:
                    ...
                    if(op.equals("a")){
                        ...
                        System.out.println("Digite o nome do objeto que será removido: ");
                        nomeObjt = sc.next();
                        portaObjetos.removerObjeto(nomeObjt);
                ...
                case 8:
                    ...
                    String nomePraia = sc.next();

                    System.out.println("Qual a localização da praia: ");
                    String locPraia = sc.next();

                    System.out.println("Qual o tamanho da praia: (em numeros)");
                ...
                case 9:
                    ...
                    System.out.println("Qual o comprimento da piscina ");
                    ...
                    System.out.println("Deseja atualizar a profundidade da água? (s/n)");
                    op = sc.next();
                ...
                case 11:
                    System.out.println("Você escolheu sair do menu.. Até logo..");
                    saiu = true;
                    break;
            }
        }
